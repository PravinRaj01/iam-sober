  ...
  return (
    <Card className="bg-card/50 backdrop-blur-lg border-border/50">
      <CardHeader className="pb-2">
        ...
        <p className="text-xs text-muted-foreground">{t("health.lastSync")} {lastSyncTime}</p>
      </CardHeader>
      <CardContent className="space-y-3">
        <div className="grid grid-cols-2 gap-3">
          <div className="flex items-center gap-2 p-2 rounded-lg bg-muted/30">
            ...
            <div>
              <p className="text-xs text-muted-foreground">{t("health.avgSleep")}</p>
          ...
          <div className="flex items-center gap-2 p-2 rounded-lg bg-muted/30">
            ...
            <div>
              <p className="text-xs text-muted-foreground">{t("health.avgSteps")}</p>
          ...
          {latest.heart_rate && (
            <div className="flex items-center gap-2 p-2 rounded-lg bg-muted/30">
              ...
              <div>
                <p className="text-xs text-muted-foreground">{t("health.heartRate")}</p>
          ...
          <div className="flex items-center gap-2 p-2 rounded-lg bg-muted/30">
            ...
            <div>
              <p className="text-xs text-muted-foreground">{t("health.avgStress")}</p>
